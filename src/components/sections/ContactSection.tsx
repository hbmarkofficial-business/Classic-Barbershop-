          ...
          <AnimateOnScroll animation="slide-right">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button variant="goldOutline" size="xl" asChild>
                <a href="tel:03063420267">Jetzt anrufen</a>
              </Button>
            </div>
          </AnimateOnScroll>
          ...
          <AnimateOnScroll animation="slide-left">
            <div className="relative">
              <div className="aspect-square lg:aspect-[4/5] rounded-sm overflow-hidden border border-border">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1243650.6894187501!2d10.916565856250013!3d52.49714450000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47a85136269a5f5d%3A0x77af232e3b226aae!2sClassic%20Barbershop!5e0!3m2!1sde!2sde!4v1772054631692!5m2!1sde!2sde"
                  width="100%"
                  height="100%"
                  ...
                  title="Standort Sandro’s Barbershop – Mönchengladbach"
                />
              </div>
