  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Berlin | Classic Barbershop</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Classic Barbershop in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Classic Barbershop | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="Classic Barbershop | Premium Barbershop Berlin" />
        <meta
